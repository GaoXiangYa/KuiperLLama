...
class Tensor {
 public:
  Tensor(base::DataType data_type, std::initializer_list<std::int32_t> init_dim, bool need_alloc,
         std::shared_ptr<base::DeviceAllocator> alloc = nullptr, void* ptr = nullptr);
  Tensor(base::DataType data_type, std::size_t size, bool need_alloc,
 ...
 private:
  ...
  void InitBuffer(std::shared_ptr<base::DeviceAllocator> alloc, void* ptr = nullptr);
